...
public class CompileUtils {
    ...
    private static final String COORDINATED_OPERATOR_SLOT_SHARING_GROUP_PREFIX =
    ...
    private static String getCoordinatedOperatorSlotSharingGroup(String agentName) {
        validateAgentName(agentName);
        return COORDINATED_OPERATOR_SLOT_SHARING_GROUP_PREFIX + agentName;
    }
    ...
    private static <K, IN, OUT> DataStream<OUT> coordinatedConnect(
        ...
        return (DataStream<OUT>)
                keyedInputStream
                        ...
                        .slotSharingGroup(getCoordinatedOperatorSlotSharingGroup(agentName))
