...
public interface ActionStateStore extends AutoCloseable {
    ...
    /**
     * Scopes subsequently generated state keys by the given dynamic plan sequence, isolating cached
     ...
     *
     * @param planVersion the sequence of the plan now live on this subtask
     */
