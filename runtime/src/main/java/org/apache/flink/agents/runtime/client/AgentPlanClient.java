...
/** Client for staging a complete AgentPlan update on a running Flink Agents job. */
public final class AgentPlanClient implements AutoCloseable {
    ...
    /** Serializes and stages a complete plan for the named deployed agent. */
    ...
    /** Stages a complete plan JSON document for the named deployed agent. */
    ...
    /** Confirmation that the coordinator accepted and staged an update. */
