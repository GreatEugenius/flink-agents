...
public class JavaResourceAdapter {
    ...
    /**
     * Retrieves a Java tool by name. This method is intended for use by the Python interpreter.
     *
     * @param name the name of the tool to retrieve
     * @return the tool
     */
    public Tool fromToolName(String name) {
        return (Tool) getResource.apply(name, ResourceType.TOOL);
    }
}
