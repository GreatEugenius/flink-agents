...
public class PythonResourceAdapterImpl implements PythonResourceAdapter {
    ...
    private static final String GET_RESOURCE_KEY = "get_resource";

    private static final String PYTHON_MODULE_PREFIX = "python_java_utils.";

    private static final String GET_RESOURCE_FUNCTION =
            PYTHON_MODULE_PREFIX + "get_resource_function";

    private static final String CALL_METHOD = PYTHON_MODULE_PREFIX + "call_method";

    private static final String CREATE_RESOURCE = PYTHON_MODULE_PREFIX + "create_resource";

    private static final String FROM_JAVA_TOOL = PYTHON_MODULE_PREFIX + "from_java_tool";

    private static final String FROM_JAVA_PROMPT = PYTHON_MODULE_PREFIX + "from_java_prompt";
    ...
    private Object convertToPythonTool(Tool tool) {
