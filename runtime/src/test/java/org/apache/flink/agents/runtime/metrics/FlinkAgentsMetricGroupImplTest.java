...
public class FlinkAgentsMetricGroupImplTest {
    ...
    @Test
    public void testGetMeterWithouCounter() {
    ...
    @Test
    public void testGetMeterWithCounter() {
        String name = "testMeter";
    ...
    @Test
    public void testGetHistogramWithoutWindowSize() {
    ...
    @Test
    public void testGetHistogramWithWindowSize() {
        String name = "testHistogram";
        int windowSize = 200;
